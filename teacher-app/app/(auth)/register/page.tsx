...
import { PlayCircle, Mail, Lock, User, AlertCircle, CheckCircle } from "lucide-react";
                ...
                <div className="glass-card p-8">
                    ...
                    <div className="relative my-4">
                        ...
                        <div className="relative flex justify-center">
                            <span className="bg-surface-card px-3 text-slate-500 text-xs">or register with email</span>
                        </div>
                    </div>
